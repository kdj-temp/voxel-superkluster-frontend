                            ...
                            <CollectionDiv className="card-box-shadow-style" style={{borderRadius:'15px'}} key={collection.id}>
                                <a href={`collection-detail/` + collection.link}>
                                    <CardDiv className="card" style={{ height: 'auto' }}>
                                        <LazyLoadImage effect="opacity" className="lazy card-img-top" src={collection.featured ? collection.featured : "/img/background/1.jpg"} afterLoad={() => setLoadImgStatus(!loadImgStatus)} style={{ aspectRatio:'8/5', objectFit:'cover', objectPosition:'50% 15%'}} alt="Bologna" />
                                        <div style={{ textAlign: 'center', marginTop: -20, marginBottom: 10}}>
                                            <div style={{position:'relative', width:50, height:50, display:'inline-block'}}>
                                                <div>
                                                    <LazyLoadImage effect="opacity" className="lazy card-img-top" src={collection.avatar ? collection.avatar : "/img/collections/coll-1.jpg"} afterLoad={() => setLoadImgStatus(!loadImgStatus)} style={{ width: 50, height: 50, borderRadius: '50%', border: '2px solid white' }} alt="Bologna" />
