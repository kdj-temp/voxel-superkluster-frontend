...
import { Tooltip, Select, Button, Input, DatePicker, Affix, Collapse, Spin, notification, Statistic } from 'antd';
...
const ListItemPage = ({ nftId ,colormodesettle }) => {
    ...
    const tomorrow = [year, month, to_date].join('-');
    ...
    useEffect(() => {
        ...
        // console.log(JSON.parse(itemDetailData),'parse(itemDetailData)') ;
        if (itemDetailData) {
    ...
    useEffect(() => {
        // console.log(colormodesettle.ColorMode,'checking');
    ...
    const sendAddItemTxHash = async (txHash, times = 0) => {
      ...
      const listAction = async (chainType) => {
        // let approve_flg = localStorage.getItem (isItemDetailData.collection.name) ;
        setClickList(false) ;
        let signMsgData;
        
        // console.log((isEndDate - new Date().getTime() )/1000/2600/24 , new Date().getDate())  ;
        // console.log((isToDate - new Date().getTime() )/1000/2600/24)  ;
        // return ;
        if (isType === "fixed") {
            signMsgData = {
                type: isType,
        ...
        // console.log(approve_flg,'approve_flg' , chainType , isType , signMsgData) ;
        ...
        // }else{
            ...
            // console.log(signMsgData,'isItemDetailData',params);
    ...
    const handlePost = async (param) => {
        ...
        if (isItemDetailData.is_721) {
            ...
            if (res && res.status == 200) {
                ...
                //     message: 'Your NFT is successfully listed for sale. Good luck!',
                // });
                    ...
                    <>
                        ...
                        <section className="custom-container">
                                    ...
                                    <div className={ isType === "auction" ? "hide" : "" } >
                                        ...
                                        <div style={{ ...displayStyle2, alignItems: 'center' }}>
                                            ...
                                            <div style={{ width: '55%', margin: '0px 0px 0px 5px' }}>
                                                ...
                                                &nbsp;(<img style={{ width: 16, height: 16, marginBottom: 5 }} src="/img/icons/ethIcon.png" /><span style={{fontWeight:'bold'}}>{(!isAmountUSD || isAmountUSD == '') ? '0':(parseFloat(isAmountUSD) / parseFloat(ethPrice)).toFixed(2)}</span>)
                                            ...
                                            {/* <div style={{ width: '45%', margin: '0px 0px 0px 5px'}}>
                                                <StyledSelect defaultValue="1" onChange={handleSelectChange} disabled>
                                        ...
                                        <div>
                                            ...
                                            <div className='date-picker-div'>
                                                <RangePicker 
                                                    ...
                                                    // defaultValue={[moment(today, dateFormat), moment(tomorrow, dateFormat)]} 
                                    ...
                                    <div className={ isType === "fixed" ? "hide" : "" } >
                                        ...
                                        <div>
                                            ...
                                            <div style={{ ...displayStyle2, alignItems: 'center' }}>
                                                ...
                                                {/* <div style={{ width: '35%', margin: '0px 5px 0px 0px'}}>
                                                    <StyledSelect defaultValue="method" onChange={handleSelectChange} disabled>
                                                        <Option value='method'>{isTokenETH == "ETH" ? <><StyledTokenImg src="/img/ethereum.svg" />ETH</> : <><StyledTokenImg src="/img/VXL.png" />VXL</>}</Option>
                                                    </StyledSelect>
                                                </div>
                                                <div style={{ width: '65%', margin: '0px 0px 0px 5px' }}>
                                                    <StyledInput placeholder="Amount" onChange={(e) => setAmount(e.target.value)} value={isAmount ?? ""} />
                                                </div> */}
                                            </div>
                                        </div>
                                        <div style={{display:'block'}}>
                                            ...
                                            <div className='date-picker-div'>
                                                {/* {console.log(moment().endOf('second') ,moment().endOf('day'),moment().endOf('minute'))} */}
                                    ...
                                    <PreContainer>
                                        <PreviewDiv>
                                            ...
                                            <div style={{ borderRadius: 10, overflow: 'hidden', width: '100%' }} className="card-border">
                                                <div>
                                                    <div>
                                                        {/* <StyledImg src={isItemDetailData.image ? isItemDetailData.image : "/img/collections/coll-item-1.jpg"} /> */}
                                                        <StyledImg src={isItemDetailData.image_preview ? isItemDetailData.image_preview : (isItemDetailData.image ? isItemDetailData.image : "/img/collections/coll-item-1.jpg")} />
                                                    </div>
                            ...
                            <div className='mt-3 mb-3' style ={window.innerWidth < 768 ? {display:'flex', justifyContent:'center'}:{}}>
                                ...
                                <StyledButton size="large" onClick={isItemDetailData.status == "active" ? () => listAction("onChain") : () => listAction("offChain")} data-bs-toggle="modal" data-bs-target="#listing" disabled={listingQuantity != '' && listingQuantity > 0 && isAmountUSD && isAmountUSD >= 0 && (isType != 'fixed' || isType === 'fixed' && isToDate) && (isType != 'auction' || isType === 'auction' && isStartDate && isEndDate) && isClickList && (!isReserve || isReserve && isValidReserveAddr) ? false : true}>Complete listing</StyledButton>
                                {isType == 'auction' &&
