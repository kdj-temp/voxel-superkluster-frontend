...
import { Button, Modal, Input, Spin, Affix } from 'antd';
...
const Privacy = function ({colormodesettle}) {
    useEffect(()=>{
                ...
                <section className='custom-container'>
                    <Div className="row" style={{ margin: '50px 5vw 0px 5vw', paddingLeft:'vw', wordBreak:'keep-all'}}>
                        ...
                        <Div>
                            ...
                            {/* <EmailLink>info@voxelxnetwork.com</EmailLink> */}
                        ...
                        {/* <Div>
                            <h3 style={{ marginBottom: 5 }}>GDPR</h3>
                            <BorderLine style={{ width: 58 }}/>
                            <Div>
