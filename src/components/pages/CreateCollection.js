...
const CreateCollectionPage = ({colormodesettle}) => {
    ...
    const prefix = 'https://superkluster.io/collection-detail/';
    ...
    const sendData = () => {
        ...
        if(data) {
            ...
            // console.log(createItems,'crateItems_detail');
            const clearState = () => {
                setName('')
                setItemDescription('')
                setWebsiteLink('')
                                    ...
                                    <div className="field-set ">
                                        ...
                                        { isRoyalty ?
                                            <div className="mb-3">
                                                ...
                                                <input type="text" name="item_supply" id="item_supply" onChange={(e) => setRoyaltyAddress(e.target.value)} value={royaltyAddress} className="form-control mt-2" placeholder="0x.." />
                                            </div> : 
                                            null
                                        }
