        ...
        <div className="author-top-div">
              <div className="mb-4 user-info-div">
                <div className="author-avatar profile_avatar" style={{ marginRight: 15}}>
                  <AvatarImg src={(isAuthorInfo && isAuthorInfo.avatar) ? isAuthorInfo.avatar : '/img/misc/avatar-1.png'} />
                ...
                <div style = {{display:'flex', alignItems:'center'}}>
                  <span>
                    <div style={{display: 'flex'}}>
                      <div onClick={(e) => handleTab('followers')} style={{cursor: 'pointer', paddingRight: '10px'}}><b className="followInfo">{isFollowNumCount}</b>{isFollowNumCount == '1' ? tab == 'followers'? <b> follower       </b>:' follower       ' : tab == 'followers'? <b> followers       </b>: ' followers       '}</div>
                      &nbsp;<div onClick={(e) => handleTab('followings')} style={{cursor: 'pointer'}}><b className="followInfo">{followingNum}</b>{tab == 'followings' ? <b> following </b>:' following'}</div>
                    </div>
                  </span>
