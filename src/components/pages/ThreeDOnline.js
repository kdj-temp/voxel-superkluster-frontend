    ...
    useEffect(() => {
        ...
        if (animation != null) {
            let posi = Init3DViewerFromFileList(ref.current, tmp, {
                environmentSettings : {
                    environmentMap : [
                        './img/3d_env_images/posx.jpg',
                        './img/3d_env_images/negx.jpg',
                        './img/3d_env_images/posy.jpg',
                        './img/3d_env_images/negy.jpg',
                        './img/3d_env_images/posz.jpg',
                        './img/3d_env_images/negz.jpg'
                    ],
