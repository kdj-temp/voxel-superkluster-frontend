...
const SocialSection = styled.div`
    border-top: 1px solid rgba(246, 12, 254, 0.2);
    display: flex;
    justify-content: space-between;
    padding-top: 26px;
    flex-wrap: wrap;
                ...
                <FooterContainer>
                    ...
                    <LinkSection>
                        ...
                        <InfoSection>
                            <Logo>
                                <Link to='/'>
                                    <img  src={colormodesettle.ColorMode == true ? "/img/logo.PNG" : "/img/logo2.png"} className="img-fluid" alt="" width="300" style={{ height:'74px', width:'361px' }} />
                                </Link>
                            </Logo>
